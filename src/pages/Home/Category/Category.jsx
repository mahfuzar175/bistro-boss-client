  ...
  return (
    <section>
      ...
      >
        <SwiperSlide>
          <img src={slid1} alt="" />
          <h2 className="text-base md:text-4xl uppercase text-center -mt-20 pb-4 text-white font-thin shadow-lg">
            Salads
          </h2>
        </SwiperSlide>
        <SwiperSlide>
          <img src={slid2} alt="" />
          <h2 className="text-base md:text-4xl uppercase text-center -mt-20 text-white font-thin shadow-lg">
            pizzas
          </h2>
        </SwiperSlide>
        <SwiperSlide>
